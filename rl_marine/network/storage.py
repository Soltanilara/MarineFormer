...
class RolloutStorage(object):
    ...
    def __init__(
        ...
        if isinstance(obs_shape, dict):
            ...
            self.dynamic_obstacle_num = obs_shape["dynamic_obstacle_states"].shape[0]
        else:
        ...
        edge_num = self.dynamic_obstacle_num + 1

        self.recurrent_hidden_states["graph_temporal_state"] = torch.zeros(
            num_steps + 1, num_processes, node_num, graph_hidden_size
        )
        self.recurrent_hidden_states["graph_edge_state"] = torch.zeros(
            num_steps + 1,
            num_processes,
            edge_num,
            graph_edge_hidden_size,
