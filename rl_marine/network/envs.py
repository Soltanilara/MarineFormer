...
from rl_marine.network.dummy_vec_env import DummyVecEnv
from rl_marine.network.shmem_vec_env import ShmemVecEnv
...
def make_vec_envs(
    ...
    if pretext_wrapper:
        raise NotImplementedError(
            "GST pretext normalization was removed from the PPO-only build"
        )
